                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Welcome,
                                                                        <strong>{{ $data['fullname'] }}</strong> has come
                                                                        to the website selling computer accessories and
                                                                        components. We are delighted that you have
                                                                        registered an account.<br>To activate your
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                                                        In case the link does not work, you can copy the
                                                                        link below and paste it into your browser</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        us via email here:
                                                                        vovankhoa2001@hotmail.com<br><em>This is an
                                                                            automated email, please do not reply to this
                                                                            email</em>
                                                                    </p>
                                                                </td>
                                                            </tr>
