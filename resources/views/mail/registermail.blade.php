...
<head>
    ...
    <title>Account registration</title><!--[if (mso 16)]>
<style type="text/css">
                        ...
                        <tr>
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0"
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="padding:0;Margin:0;padding-top:40px;padding-right:40px;padding-left:40px">
                                                                ...
                                                                <td align="left" class="es-m-txt-c"
                                                                    style="padding:0;Margin:0;font-size:0px"><a
                                                                        ...
                                                                        style="mso-line-height-rule:exactly;text-decoration:underline;color:#2D3142;font-size:18px"><img
                                                                            src="https://qmxbfp.stripocdn.email/content/guids/CABINET_ee77850a5a9f3068d9355050e69c76d26d58c3ea2927fa145f0d7a894e624758/images/group_4076323.png"
                                                                            alt="Confirm email"
                                                                            style="display:block;font-size:18px;border:0;outline:none;text-decoration:none;border-radius:100px"
                                                                            width="100" title="Confirm email"></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;letter-spacing:0;color:#2D3142;font-size:18px;text-align: justify;">
                                                                        We just wanted to take a moment to thank you for
                                                                        choosing us for your online shopping needs on
                                                                        our website. We hope that the items you ordered
                                                                        and our services meet your
                                                                        expectations.<br><br>You are receiving this
                                                                        notification because you have registered for an
...
<![endif]--><!--[if !mso]><!-- --><span class="es-button-border msohide"
                                                                        style="border-style:solid;border-color:#2CB543;background:#7630f3;border-width:0px;display:block;border-radius:30px;width:auto;mso-hide:all;mso-border-alt:10px"><a
                                                                            href="{{ $data['link'] }}"
                                                                            class="es-button msohide" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:22px;padding:15px 20px 15px 20px;display:block;background:#7630f3;border-radius:30px;font-family:Imprima, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:26px !important;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #4114F7;mso-hide:all;padding-left:5px;padding-right:5px;border-color:#7630f3">Active
                                                                            Account</a></span><!--<![endif]--></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin: 0; mso-line-height-rule: exactly; font-family: Imprima, Arial, sans-serif; line-height: 27px; letter-spacing: 0; color: #2D3142; font-size: 18px; text-align: justify;">
                                                                        If you cannot activate your account by clicking
                                                                        on the Active Account box, we have a backup link
                                                                        available:<br><br>{{ $data['link'] }}<br><br>Thank
                                                                        you
                                                                        again for registering and coming to our
                                                                        website,<br><br><b>{{ $data['fullname'] }}</b>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
