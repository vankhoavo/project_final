                                                                                ...
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        style="font-size: 0px;"><a
                                                                                            target="_blank"><img
                                                                                                src="https://xgxxwe.stripocdn.email/content/guids/CABINET_54100624d621728c49155116bef5e07d/images/84141618400759579.png"
                                                                                                alt
                                                                                                style="display: block;"
                                                                                                width="100"></a></td>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <h2>Order&nbsp;<a
                                                                                                target="_blank">{{ $data['invoice_code'] }}</a>
                                                                                        </h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
...
<![endif]-->
                                                                                        <!--[if !mso]><!-- --><span
                                                                                            ...
                                                                                            style="border-radius: 6px; border-color: #5c68e2; border-width: 2px; background: #5c68e2;"><a
                                                                                                ...
                                                                                                target="_blank"
                                                                                                style="padding-left: 30px; padding-right: 30px; border-radius: 6px">TRACK
                                                                                                ORDER STATUS</a></span>
                                                                                        <!--<![endif]-->
                                                                                    </td>
                                                                                </tr>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p10t es-p10b es-p20r es-p20l esdev-adapt-off"
                                                        align="left" esd-custom-block-id="388986">
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td align="left"
                                                                                                            ...
                                                                                                            <p><strong>{{ $value->product_name }}</strong>
                                                                                                            </p>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                    ...
                                                                    <td width="560"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        class="esd-block-text es-p10t es-p20b es-m-txt-c">
                                                                                        <p style="line-height: 120%;">
                                                                                            <br>Total:
                                                                                            <strong>${{ $data['total_money'] }}</strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
