                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p>Phone
                                                                                            Number:&nbsp;<strong>{{ $data['receiving_phone_number'] }}</strong>
                                                                                        </p>
                                                                                        <p>Address:&nbsp;<strong>{{ $data['receiving_address'] }}</strong>
                                                                                        </p>
                                                                                        <p>Payment
                                                                                            method:&nbsp;<strong>Transfer
                                                                                                Banking</strong>
                                                                                        </p>
                                                                                        <p>Currency:&nbsp;<strong>VND</strong>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
