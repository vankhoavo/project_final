                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://qmxbfp.stripocdn.email/content/guids/CABINET_91d375bbb7ce4a7f7b848a611a0368a7/images/69901618385469411.png"
                                                                        alt=""
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        After you click the button, you'll be asked to
                                                                        complete the following steps:</p>
                                                                    <ol
                                                                        style="font-family:arial, 'helvetica neue', helvetica, sans-serif;padding:0px 0px 0px 40px;margin:15px 0px">
                                                                        <li style="color:#333333;margin:0px 0px 15px">
                                                                            Enter a new password.</li>
                                                                        <li style="color:#333333;margin:0px 0px 15px">
                                                                            Confirm your new password.</li>
                                                                        <li style="color:#333333;margin:0px 0px 15px">
                                                                            Click Submit.</li>
                                                                    </ol>
                                                                </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Thank you for requesting a password reset for
                                                                        your account. If you cannot click on the RESET
                                                                        YOUR PASSWORD link, you can contact us via
                                                                        email: {{ $data['email'] }}.<br><br>Or you can
                                                                        try the
                                                                        link below that we have available for you:
                                                                        {{ $data['link'] }}<br><br>Thank you,
                                                                        <b>{{ $data['fullname'] }}</b></p>
                                                                </td>
                                                            </tr>
                                                        </table>
